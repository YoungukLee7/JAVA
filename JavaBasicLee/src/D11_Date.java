...
public class D11_Date {
	/*
	 ...
	 - 주로 시간 값을 담아놓는 용도로 사용한다
	 */
	public static void main(String[] args) {
		// System.currentTimeMillis() : 현재의 유닉스 타임을 구한다
		// 유닉스 타임 - 1970년 1월1일 이후로 시간이 얼마나 흘렀는지를 1/1000초로 센것
		...
		// Date 클래스의 많은 메서드들은 더이상 자바가 지원하지 않는다
		...
		//시간 및 날짜를 다룰때 long타입을 요구하는 파라미터는 대부분 유닉스 타임을 의미한다
