...
class NotCaesarKeyException extends RuntimeException{
	public NotCaesarKeyException(String msg) {
		super(msg);
	}
}

public class E09_FileEncryption1 {
	/*
	 # 시저 암호
...
//	final static String CHARSET = UPPERCASE + LOWERCASE;
	...
	public static void encryptFile(File text, int key) {
		if (key < 0 || key > 26) {
			throw new NotCaesarKeyException("1 <= key < 26");
		}
	...
	public static void main(String[] args) {
		encryptFile(new File("files/frankenstein.txt"), 22);
	}
}
