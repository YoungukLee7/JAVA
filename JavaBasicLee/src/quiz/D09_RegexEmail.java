...
public class D09_RegexEmail {
	...
	/*
	 1. emails 문자열에 있는 모든 이메일들을 ArrayList에 저장해보세요
	 2. 어떤 도메인(chosun.com,munhwa.com 등 )이 몇개씩 있는지 세어서 출력해보세요
...
//
//		Pattern emailPattern = Pattern.compile("\\S+@[a-zA-Z]+[.][a-zA-Z]{2,3}[.]*[a-zA-Z]*");
//
//		Matcher matchResult = emailPattern.matcher(emails);
//
//		while (matchResult.find()) {
//			list.add(emails.substring(matchResult.start(),matchResult.end()));
//		}
//		
...
//		
//		// 2번----------------------------------------------------------------------------------------
//		String emailBack = list.toString();
//		
//		HashMap<String, Integer> emailCount = new HashMap<>();
//		ArrayList<String> listBack = new ArrayList<>();
//		
//		System.out.println(emailBack);
//		
//		Pattern email = Pattern.compile("[a-zA-Z]+[.][a-zA-Z]{2,3}[.]*[a-zA-Z]*");
//		
//		Matcher match = email.matcher(emailBack);
//		
//		int cnt = 1;
//		while (match.find()) {
//			listBack.add(emailBack.substring(match.start(),match.end()));
//		} 
...
//		Pattern domainPattern = Pattern.compile("@\\\\w+\\\\.\\\\w+(\\\\.\\\\w+)*"); 이렇게 해주는 것보다 위에 가로쳐서 해준다
		...
		while (emailMatcher.find()) { 
			emaiList.add(emailMatcher.group());
...
//		return count.compareTo(d.count) * -1;
	}
	
	@Override
	public String toString() {
		return String.format("[%-20s / %2d]", domain,count);
	}
}
