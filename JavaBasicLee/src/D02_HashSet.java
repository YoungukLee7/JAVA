...
public class D02_HashSet {
	...
	/*
	 ...
	 - Hash의 결과 값은 숫서가 존재하지 않기 때문에 index가 존재하지 않는다
	 - 주로 특정 데이터의 고유 번호로 활용된다
	 "abc"  -> ba7816b....
	 "abcd" -> 88d4266....
	 "cat"  -> 77af778....
	 */
	...
	public static void main(String[] args) {
		// add(item) : List와 Set 모두 Collection의 자식이기 때문에 거의 같은 메서드를 사용한다
		...
		// 순서가 매번 바뀌어서 인덱스가 의미 없을 뿐, 값을 순서대로 하나씩 꺼내는 것은 가능하다
		for (String fruit : fruits) {
			System.out.println(fruit);
		}
		
		System.out.println("Set에 크기: " + fruits.size());
