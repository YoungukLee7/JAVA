...
public class E04_JavaIO {
	/*
	 ...
	 - 프로그램으에서 계산되어 나가는 모든 데이터들을 출력(Output)이라고 부른다
	...
	public static void main(String[] args) {
		try {
			...
			// 다 쓴 통로는 반드시 닫아줘야 한다 (프로그램 스스로 언제 닫아야 할지 결정하지 못한다.)
			out.close();
			
		// new FileOutputStream 때문에 밑에것을 반드시 처리해줘야 한다
		} catch (FileNotFoundException e) {
			e.printStackTrace();
		// out.write 때문에 밑에것을 반드시 처리해줘야 한다
		} catch (IOException e) {
